...
<!-- End Google Tag Manager -->
      ...
      <title>EGD Test or Endoscopy: Upper Endoscopy to Detect Digestive Problems</title>
      <meta name="description" content="An esophagogastroduodenoscopy or EGD test is also called the upper endoscopy that helps doctors examine the upper part of the gastrointestinal tract to treat symptoms and conditions. Read more about how EGD test is performed">
      <meta property="og:description" content="An esophagogastroduodenoscopy or EGD test is also called the upper endoscopy that helps doctors examine the upper part of the gastrointestinal tract to treat symptoms and conditions. Read more about how EGD test is performed">
      <meta property="og:type" content="Blog">
      <meta property="og:title" content="EGD Test or Endoscopy: Upper Endoscopy to Detect Digestive Problems">
      <meta property="og:url" content="https://cmclancaster.com/blog/endoscopy-procedure/">
      <meta property="og:site_name" content="CMC Lancaster">


<meta property="article:publisher" content="https://www.facebook.com/cmcl.us" />
<meta property="article:tag" content="EGD test" />
<meta property="article:tag" content="Esophagogastroduodenoscopy" />
<meta property="article:tag" content="Endoscopy" />
<meta property="article:tag" content="Gastroesophageal reflux disease" />
<meta property="article:tag" content="Inflammation and ulcers" />
<meta property="article:tag" content="inflammation of duodenum" />
<meta property="article:tag" content="inflammation of esophagus" />
<meta property="article:tag" content="inflammation of stomach" />
<meta property="article:tag" content="Cancer and Tumors" />
<meta property="article:tag" content="Esophageal stricture" />
<meta property="article:tag" content="Esophageal varices" />
<meta property="article:tag" content="How EGD test is performed" />



      <meta name="twitter:card" content="summary">
      <meta name="twitter:title" content="EGD Test or Endoscopy: Upper Endoscopy to Detect Digestive Problems">
      <meta name="twitter:description" content="An esophagogastroduodenoscopy or EGD test is also called the upper endoscopy that helps doctors examine the upper part of the gastrointestinal tract to treat symptoms and conditions. Read more about how EGD test is performed" >

      <link rel="canonical" href="https://cmclancaster.com/blog/endoscopy-procedure/">
      <link rel="alternate" href="https://cmclancaster.com/blog/endoscopy-procedure/" hreflang="en-us" />
...
"description": "EGD test or Endoscopy is a painless process. Your doctor will insert the endoscope, a long, thin, flexible pipe fitted with a tiny camera and light at its leading tip, into your mouth and push it gently through your throat. You may be asked to swallow as the scope passes down your throat. As the endoscope is forwarded down your esophagus, the images from the camera will be shown on a monitor. Your doctor will observe the image minutely to find out if there is any abnormality in your upper digestive tract. Gentle air pressure may be used to inflate your digestive tract. This allows the endoscope to move freely inside the tract." 
}
</script>
         ...
         <main id="main" class="main-content" role="main">
            <section class="page-banner page-banner-landing full-page">
               <div class="bg bg-image"
                  style="background-image: url('https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/EGD-Test.jpg');
                  background-position: 49% 48%;"
                   alt="EGD Test"></div>
               <div class="row">
                  <div class="column">
                     <div class="page-banner-content">
                        <h1><span class="dotted-underline">Esophagogastroduodenoscopy</span></h1>
                        <!-- <p>
               ...
               <div class="row">
                  <div class="column large-10 large-centered">
                     <ul class="breadcrumbs">
                        ...
                        <li class="active">Esophagogastroduodenoscopy</li>
...
<p>
  An EGD test can help identify many different diseases. Here is a list of them - </p>
 <p> 
1. GERD or Barrett’s esophagus<br>
<a href="../gastrointestinal-diseases/" target="_blank"> Gastroesophageal reflux disease or GERD,</a> that happens when gastric acid flows back from the stomach into the esophagus. GERD causes damage of the esophagus wall. It can also result in the growth of abnormal cells, also known as Barrett’s esophagus that may cause cancer. 
</p>
<p>
...
<p>
   2. Inflammation and ulcers<br>
<p>Inflammation of various parts of the upper GI tract that include -<br>
  <ul>
<li>Duodenitis - inflammation of duodenum, </li>
<li>Esophagitis - inflammation of esophagus, and </li>
<li>Gastritis - inflammation of stomach. </li>
</ul><li>
  <p>
Helicobacter Pylori infection is the main cause of inflammation which can lead to erosion and ulcer conditions such as duodenal and peptic ulcer.  
Typical symptoms of the upper GI tract inflammations are frequent nausea, vomiting, belching, bloating, and burning stomach pain. </p>
<p>
3. Cancer and Tumors<br>
 Ulceration, abnormal bumps, and polyps are the likely causes of cancer in the upper GI tract. Biopsies are taken by the doctors and sent for examination to find if they are benign or malignant. Stomach cancer and esophagus cancer are the most common types of cancer in the upper GI tract, whereas the duodenal cancer is relatively rare.</p>
 <p>
...
<p>
4. Esophageal stricture<br>
Esophagus stricture is a condition that means narrowing of the esophagus whose probable causes may be GERD or tumors. It blocks the passage of foods and liquids from going into the stomach. </p>
<p>
Typical symptoms of esophageal stricture are chest pressure, difficulty in deep breathing, difficulty in swallowing, and vomiting. EGD test or GI endoscopy is a proven procedure to cure esophageal stricture.</p> 

<p>
5. Esophageal varices<br>
...
<h2 class="blogh2">How EGD test is performed</h2>
<p>EGD test or Endoscopy is a painless process. Your doctor will insert the endoscope, a long, thin, flexible pipe fitted with a tiny camera and light at its leading tip, into your mouth and push it gently through your throat. You may be asked to swallow as the scope passes down your throat.</p> 
<p>
As the endoscope is forwarded down your esophagus, the images from the camera will be shown on a monitor. Your doctor will observe the image minutely to find out if there is any abnormality in your upper digestive tract. Gentle air pressure may be used to inflate your digestive tract. This allows the endoscope to move freely inside the tract.</p>

<p>
If any polyps are found they are removed by the doctor using a special surgical tool passed through the endoscope, and then sent for malignancy test. </p>
<p>
