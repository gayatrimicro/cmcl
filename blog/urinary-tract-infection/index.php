...
<!-- End Google Tag Manager -->
      ...
      <title>Urinary Tract Infections or UTI: Causes, Symptoms &amp; Treatment</title>
      <meta name="description" content="A UTI or Urinary tract infection can occur in kidneys, ureters, bladder, and the urethra. Read more the causes, symptoms &amp; treatments for UTI">
      <meta property="og:description" content="A UTI or Urinary tract infection can occur in kidneys, ureters, bladder, and the urethra. Read more the causes, symptoms &amp; treatments for UTI">
      <meta property="og:type" content="Blog">
      <meta property="og:title" content="Urinary Tract Infections or UTI: Causes, Symptoms &amp; Treatment">
      <meta property="og:url" content="https://cmclancaster.com/blog/urinary-tract-infection/">
      <meta property="og:site_name" content="CMC Lancaster">

<meta property="article:tag" content="Urinary Tract Infections" />
<meta property="article:tag" content="Causes of UTI" />
<meta property="article:tag" content="Symptoms of UTI" />
<meta property="article:tag" content="Bladder infection" />
<meta property="article:tag" content="Kidney infection" />
<meta property="article:tag" content="Treatments for UTI" />
<meta property="article:tag" content="kidney stones" />
<meta name="Focus" content="Urinary Tract Infection" />
<meta name="sailthru.tags" content="Urinary Tract Infection, UTI Causes, UTI Symptoms"/>
<meta name="sailthru.image.thumb" content=""/>
      ...
      <meta name="twitter:title" content="Urinary Tract Infections or UTI: Causes, Symptoms &amp; Treatment">
      <meta name="twitter:description" content="A UTI or Urinary tract infection can occur in kidneys, ureters, bladder, and the urethra. Read more the causes, symptoms &amp; treatments for UTI" >

      <link rel="canonical" href="https://cmclancaster.com/blog/urinary-tract-infection/">
      <link rel="alternate" href="https://cmclancaster.com/blog/urinary-tract-infection/" hreflang="en-us" />
...
"mainEntityOfPage":{
"@type":"WebPage",
"@id":"https://cmclancaster.com/blog/urinary-tract-infection"
},
"headline": "Urinary Tract Infections or UTI: Causes, Symptoms & Treatment",
"image": {
"@type": "ImageObject",
"Url": "",
"height": 625,
...
"description": "A UTI or Urinary tract infection can occur in kidneys, ureters, bladder, and the urethra. Read more the causes, symptoms &amp; treatments for UTI", 
"articleBody": "Our urinary system or tract consists of four organs - kidneys, ureters, bladder, and the urethra. A UTI or Urinary tract infection can occur in any of these parts. However, most infections affect the bladder and urethra, parts our lower urinary tract. Personal hygiene plays a very important role in keeping UTI at bay, especially for women.A lower UTI is easier to treat than the upper UTI that includes the kidney infection which gets complicated more often. Urinary tract infections are bacterial infections that can affect you irrespective of your sex or age. However, statistics show that women are at greater risk of UTI than men. While women of any age can develop a UTI, men usually become susceptible to it after the age of 50.  "
}
</script>
...
<div class="bg bg-image" style="background-image: url('https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/Urinary-tract-infection.jpg'); background-position: 49% 48%;" alt="Urinary tract infection"></div>
               <div class="row">
                  <div class="column">
                     <div class="page-banner-content">
                        <h1><span class="dotted-underline">Urinary Tract Infections</span></h1>
                        <!-- <p>
               ...
               <div class="row">
                  <div class="column large-10 large-centered">
                     <ul class="breadcrumbs">
                        ...
                        <li class="active">Urinary Tract Infections - Treat them before they get complicated</li>
                        
                     </ul>
                      <h1 class="blogh1">Urinary Tract Infections - treat them early before they get complicated.
</h1>
                    
                     <p>Our urinary system or tract consists of four organs - kidneys, ureters, bladder, and the urethra. A UTI or Urinary tract infection can occur in any of these parts. However, most infections affect the bladder and urethra, the parts belong to our. Personal hygiene plays a very important role in keeping UTI at bay, especially for women.</p>
<p>A lower UTI is easier to treat than the upper UTI that includes the kidney infection which gets complicated more often. </p>

<p>
Urinary tract infections are bacterial infections that can affect you irrespective of your sex or age. However, statistics show that women are at greater risk of UTI than men. While women of any age can develop a UTI, men usually become susceptible to it after the age of 50.  </p> 
...
<ul>
<li>Frequent and intense sexual intercourse, especially with multiple or new partners</li>
<li>Diabetes</li>
<li>Poor personal hygiene</li>
<li>The bladder remains unemptied after urinating </li>
<li>Having a urinary catheter</li>
<li>Bowel incontinence</li>
<li>Blocked flow of urine</li>
<li>Kidney stones</li>
<li>Some forms of contraception</li>
<li>Pregnancy</li>
<li>Menopause</li>
<li>Procedures involving the urinary tract</li>
<li>Suppressed immune system</li>
<li>Immobility for a long period</li>
<li>Use of spermicides and tampons</li>
</ul>

</p>


<h2 class="blogh2">Symptoms of UTI
</h2>
<p>You may notice one or more of the following symptoms if you have got a UTI, but some of them may come due to other conditions as well and disappear after a day or two. 
  <ul>
<li>A strong, persistent urge to urinate</li>
<li>A burning sensation when urinating</li>
<li>Passing frequent, small amounts of urine
...
<h2 class="blogh2">
Bladder infection </h2>
<p>
 Bladder infection is caused when bacteria that enter through the urethra and get into the bladder, are not flushed out by the flow of urine. The bacteria cling to the bladder wall and multiply. This overpowers the body’s immune system and affects the efficacy of the bladder. </p>
<p>Women are more likely to catch bacteria as their urethra is located very close to the vagina and rectum which are the main sources of bacteria.</p>
...
<h2 class="blogh2">Kidney infection
</h2>

<p>
  Kidney infections are caused mainly when the bacteria in the bladder spread to the kidneys. A type of bacteria called E. coli is mainly responsible for kidney infections. However, a kidney infection can also take place due to a bacterial invasion through the skin to mix with blood and reach the kidney. Also, you can get a kidney infection after a <a href="https://cmclancaster.com/blog/kidney-dialysis-treatment-for-kidney-failure/" target="_blank"> kidney surgery</a>, but that is very uncommon. 
...
<p>Since bacteria are the main causes of UTI they are normally treated with prescription medications in the form of antibiotics or antimicrobials to kill the bacteria and medications for relief from pain and burning. </p>
<p>
However, the type of medication depends upon factors such as the symptoms and the medical history of the patient. For relieving pain and burning sensation associated with a bladder infection, doctors generally prescribe phenazopyridine, also known as pyridine. </p>
<p>
