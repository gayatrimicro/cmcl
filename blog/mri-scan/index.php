...
<!-- End Google Tag Manager -->
      ...
      <title>All you wanted to know about MRI scan</title>
      <meta name="description" content="MRI stands for Magnetic resonance imaging, is an imaging process that uses magnetic properties. This is an absolutely safe & painless(non-invasive) procedure.">

      <meta property="og:description" content="MRI stands for Magnetic resonance imaging, is an imaging process that uses magnetic properties. This is an absolutely safe & painless(non-invasive) procedure.">

      <meta property="og:type" content="Blog">
      <meta property="og:title" content="All you wanted to know about MRI scan">
      <meta property="og:url" content="https://cmclancaster.com/blog/mri-scan/">
...
<meta property="article:tag" content="MRI scan" />
<meta property="article:tag" content="MRI Scan machines" />
<meta property="article:tag" content="Brain and spinal cord" />
<meta property="article:tag" content="traditional closed MRI" />
<meta property="article:tag" content="open MRI machine" />
<meta property="article:tag" content="standing or sitting MRI" />
<meta property="article:tag" content="Multiple sclerosis " />
<meta property="article:tag" content="MRI test procedure and options" />
<meta property="article:tag" content="types of MRI scan machines" />
<meta name="Focus" content="MRI scan" />
<meta name="sailthru.image.thumb" content="https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/mri-scan.jpg"/>
<meta name="sailthru.tags" content="MRI scan, MRI test procedure and options"/>




      <meta name="twitter:card" content="summary">
      <meta name="twitter:title" content="All you wanted to know about MRI scan">
      <meta name="twitter:description" content="MRI stands for Magnetic resonance imaging, is an imaging process that uses magnetic properties. This is an absolutely safe & painless(non-invasive) procedure." >

      <link rel="canonical" href="https://cmclancaster.com/blog/mri-scan/">
      <link rel="alternate" href="https://cmclancaster.com/blog/mri-scan/" hreflang="en-us" />
...
"mainEntityOfPage":{
"@type":"WebPage",
"@id":"https://cmclancaster.com/blog/mri-scan"
},
"headline": "All you wanted to know about MRI scan",
"image": {
"@type": "ImageObject",
"Url": "https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/mri-scan.jpg",
"height": 458,
"width": 1600
},
...
"description": "MRI stands for Magnetic resonance imaging, is an imaging process that uses magnetic properties. This is an absolutely safe & painless(non-invasive) procedure", 
"articleBody": "Many people get worried if doctors ask them to take an MRI test, fearing complication in their conditions. But MRI scan can help to rule out suspected complications and makes way for non-surgical treatments. Magnetic resonance imaging, the full form of MRI, is an imaging process that uses magnetic properties. This is an absolutely safe and painless(non-invasive) procedure that makes use of a large magnet, radio waves, and a computer to produce clear and detailed images of your body parts to check for a tumor or other abnormalities. "
}
</script>
...
<div class="bg bg-image" style="background-image: url('https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/mri-scan.jpg'); background-position: 49% 48%;" alt="MRI Scan"></div>
               <div class="row">
                  <div class="column">
                     <div class="page-banner-content">
                        <h1><span class="dotted-underline">MRI scan</span></h1>
                        <!-- <p>
               ...
               <div class="row">
                  <div class="column large-10 large-centered">
                     <ul class="breadcrumbs">
                        ...
                        <li class="active">All you wanted to know about MRI scan</li>
                        
                     </ul>
                      <h1 class="blogh1">All you wanted to know about MRI scan</h1>
                    
                     <p>Many people get worried if doctors ask them to take an MRI test, fearing complication in their conditions. But MRI scan can help to rule out suspected complications and makes way for non-surgical treatments. </p>
<p>
<strong>Magnetic resonance imaging</strong>, the full form of <strong> MRI</strong>, is an imaging process that uses magnetic properties. This is an absolutely safe and painless(non-invasive) procedure that makes use of a large magnet, radio waves, and a computer to produce clear and detailed images of your body parts to check for a tumor or other abnormalities. 
</p>

<p>There can be full body imaging or imaging of the individual parts. The list includes: 
<ul>
<li>Brain and spinal cord</li>
<li>Bones and joints</li>
<li>Breasts</li>
<li>Heart and blood vessels</li>
<li>Internal organs - liver and bile ducts, kidneys, spleen, pancreas, uterus, ovaries, and prostate.</li>
</ul>
</p>
<p>
...
<p>MRI scanning is performed by a <a href="https://www.insideradiology.com.au/radiographer-medical-imaging-technologist/" target="_blank" rel="nofollow">radiographer</a>. The machine creates a low-level magnetic field inside it which influences the atoms of the patient’s body. Atoms in different types of tissues react in different ways. These reactions are sensed by the scanner and are decoded in a computer for visual representation. The computer is hooked to the scanner but kept in another room. </p>
<p>
There are three types of MRI scan machines - traditional closed MRI, open MRI, and standing or sitting MRI.</p><br>

 
<section class="call-to-action cta-full-width-content content-block content-block-full-backdrop kidney" style="background-image: url(&#39;https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/mri-scan-types.jpg&#39;); background-position: 49% 60%;" alt="mri scan types">
               <div class="row">
...
<p>
A <strong>closed MRI machine</strong> is a large tube (with both ends open) inside which the patient has to lie on a table. The images produced are generally of high quality but it is important that the patient lies on the table very still. </p>
<p>
An <strong>open MRI machine</strong> has everything the same as the closed type machine except that there is no tube. Instead, there is more open space. The open MRI machine is developed to allow more comfort to patients who are claustrophobic or obese. However, the image quality is slightly compromised. </p>



<p>
In a <strong>standing or sitting type MRI machine</strong> provides the patient with the comfort of sitting or standing during the scan. However, the image quality may not be of very good.</p>
...
<li>Brain Injuries from trauma.</li>
...
<h2 class="blogh2">MRI scan for heart and blood vessel abnormalities</h2>
<p>
  The following vital information about your heart and blood vessels are found through the MRI scan. 

  <ul>
<li>Current size and function of the heart’s chambers.</li>
<li>The heart wall thickness and its movements.</li>
<li>The amount of damage caused due to a heart attack or heart disease.</li>
<li>The extent of inflammation or blockages in the blood vessels.</li>
<li>Development of the conditions such as aortic aneurysms and dissections. </li> 
...
<li>Depending on the condition an MRI test may last from 15 minutes to over an hour during when the patient shouldn’t make any movement in order to prevent blurring of an image. </li>
<li>During the scan, there may be repetitive tapping sounds from the internal parts of the machine. That is normal. The patient will be provided with earplugs or music to help block the noise. </li>

<li>During the scan, the patient may be asked to perform some simple tasks like tapping thumb against fingers or answering some questions to see which part of the brain controls them.</li>
