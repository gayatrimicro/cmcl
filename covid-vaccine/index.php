...
<html lang="en-US" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# article: http://ogp.me/ns/article#">
	 ...
	 <head>
			...
			<title>Covid Vaccine - CMCL</title>
			<!-- Google Tag Manager -->
...
<!-- End Google Tag Manager -->
			...
			<meta property="og:url" content="https://cmclancaster.com/covid-vaccine/" />

			<link rel="canonical" href="https://cmclancaster.com/covid-vaccine/">
			<link rel="alternate" href="https://cmclancaster.com/covid-vaccine/" hreflang="en-us" />
			...
			<div class="outer-container">
			 ...
			 <!--  language translator header end -->
				 <main id="main" class="main-content" role="main">
						...
						<section style="background: url(../assets/images/covlab.jpg);background-repeat: no-repeat; background-size: cover;padding: 70px 0px; ">
							<div class="MainBx">
								<p class="title" style="color: #fff !important">We'd love to hear from you</p>
								<form id="formcovid">
													 <div class="row">
															<label class="columns labelphone" style="color: #fff !important">Name</label>
															<div class="medium-12 columns" style="height: auto;z-index: 0;">
															<input type="text" id="covuser_name" name="covuser_name" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="name" maxlength="20" required style="height:auto; z-index:9999 !important;opacity: 1;visibility: visible;"/>
															</div>
													 </div>
													 <div class="row">
														<label class="columns labelphone" style="color: #fff !important">Email</label>
															<div class="medium-12 column">
																 <span class="wpcf7-form-control-wrap email-796"><input id="covuser_email" type="email" name="covuser_email" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" maxlength="50" aria-invalid="false" placeholder="Email" required /></span>
															</div>														 
													 </div>
													 <div class="row">
													 <label class="columns labelphone" style="color: #fff !important">Phone number</label>
													 <div class="medium-4 small-4 columns">
																 <span class="wpcf7-form-control-wrap text-368"><input  type="tel"  id="covphone1" name="covphone1" pattern="^(|[0-9][0-9]*)$" size="3" minlength="3" maxlength="3" class="number wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="###" required /></span>
															</div>
															<div class="medium-4 small-4 columns">
																 <span class="wpcf7-form-control-wrap text-368"><input  type="tel" id="covphone2" name="covphone2"  pattern="^(|[0-9][0-9]*)$" size="3" minlength="3" maxlength="3" class="number wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="###" required /></span>
															</div>
															<div class="medium-4 small-4 columns">
																 <span class="wpcf7-form-control-wrap text-368"><input  type="tel"  id="covphone3" name="covphone3"  pattern="^(|[0-9][0-9]*)$" size="4" minlength="4" maxlength="4" class="number wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="####" required /></span>
