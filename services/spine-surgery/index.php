...
<!-- End Google Tag Manager -->
      ...
      <title>Spine Surgery | Spine Surgery Specialists | Spine Surgery Hospital</title>
      <meta name="description" content="CMCL is the leading spine surgery hospital in USA where our spine surgery specialist helped many peoples around the world to get rid from various types of spine health issues.">
     
      <link rel="canonical" href="https://cmclancaster.com/services/spine-surgery/">
      <link rel="alternate" href="https://cmclancaster.com/services/spine-surgery/" hreflang="en-us" />
...
"mainEntityOfPage":{
"@type":"WebPage",
"@id":"https://cmclancaster.com/blog/vitamin-mineral-supplements"
},
"headline": "Vitamin and mineral supplements to help with your weight loss",
"image": {
"@type": "ImageObject",
"Url": "https://s3.ap-south-1.amazonaws.com/gwsprojects/websites/crescent/assets/images/vitamin-supplements.jpg",
"height": 350,
"width": 1440
},
...
"description": "Learn about how vitamin & mineral supplements help you to prevent nutrient deficiencies after your weight loss therapy.", 
"articleBody": "Weight management programs are not quick fixes for obesity, but rather the first steps to shedding the bulk of the extra weight that should be followed by a regimen of exercise, balanced diet, and vitamin supplements.The medical weight loss & physical rehab facility at the CMC Lancaster offers comprehensive follow-up care that includes vitamin supplementation among other services to maintain the level of essential nutrients in your body. You’ll receive a personalized program to achieve long-term freedom from obesity and a life full of vigor. Here is a list of the vitamins and supplements that the doctors and nutritionists normally suggest to prevent nutrient deficiencies after your weight loss therapy."
}
</script>
...
<div class="bg bg-image" style="background-image: url('../../assets/images/spine2.jpg'); background-position: 49% 48%;" alt="spine health"></div>
               ...
               <div class="row">
                  <div class="column">
                     <div class="page-banner-content">
                        <h1><span class="dotted-underline">Spine Surgery </span></h1>
                        <!-- <p>
               ...
               <div class="row">
                  <div class="column large-10 large-centered">
                     <ul class="breadcrumbs">
                        <li><a href="../../">Home</a> </li>
                          <li class="active"><a href="javascript:viod(0);">Spine Surgery</a> </li>
                     </ul>
                      <h1 class="blogh1 new-font-size">Never Before Experienced Spine Surgery Services</h1>
                    
                     <p>CMCL hospital’s spine surgery department can easily perform major and complicated spine surgery. We are one of the forerunners in providing specialized and exclusive spine surgery specialists who conduct detailed and highly advanced surgery procedures.</p>
   <p>                  
This is one of the best spine surgery hospitals that have the latest of equipments, surgeons who are educated from one of the best universities of the world. Our USP is our ability to take care of each and every patient and make sure they recover completely within a short span of the surgery.   
</p>

<p class="margin-top">
Our spine surgeons are skilled in treating spine disorders and other deformities using techniques like robotics etc. There is a complete package of managing treatments for the spine disorders and back pain available with us. We begin with complete check up of the spine health condition of the patient and then suggesting adequate and best treatment accordingly.  
</p>

<div class="mt-top mt-bottom">
<h2 class="blogh2 new-font-size"> Check our list and basic description of the different spine related issues and its cure is provided:</h2> 
</div>

<!-- <p>High potency, chewable multivitamin and mineral supplement that contains:</p> -->
  <!-- <ul>
 
<li>Iron - minimum of 18 mg </li>
...
<p>Doses - as directed by the doctors.
</p>    -->           
...
<p>
 If you observe an abnormal curve in spine area, it is a symptom of scoliosis. There are different types of scoliosis based on the age and cause of its development. Most of the time scoliosis occurs because of the curvature of our spine. </p>


<p>We diagnose the issue of scoliosis using imaging techniques like MRI, CT Scans and X-rays. Depending upon its severity and to prevent this condition from getting worse, we treat with bracing or in extreme conditions surgery for scoliosis.  
...
<h2 class="blogh2">2. Spine fusion Surgery</h2>

<p>The spine fusion surgery procedure is used for connecting two or more spine vertebrae, where the motion between them is eliminated. In this procedure the design is to copy the normal healing procedure of bones broken. </p>
<p>In this procedure, the surgeon places bone like material in the space between to spine vertebrae. Along with it, metal screws, plates, and rods could be used to hold the two to form a whole single unit. 
</p>



<h2 class="blogh2">3.  Micro-decompression (Microdiscectomy) Surgery</h2>

<p>Whenever a patient suffers from pain due to pressure on its spine nerve root, also called herniated disc - we perform microdiscectomy or micro-decompression surgery procedure. 
</p>
<p class="blogh2">
 This technique of surgery has been considered as gold standard in the removal of a herniated portion of spine disc that usually presses on the nerves. Our spine surgeons have a long experience in dealing with this condition.  
</p>

<h2 class="blogh2">4. Laminectomy (Decompression Surgery)</h2>
<p>
Decompression surgery is a procedure that will create space between your spine bones through the removal of lamina. Lamina is the back portion of vertebrae that covers spine canal. 
</p>

<p>This procedure is also known as decompression surgery through which your spine column is enlarged to relive pressure on your nerves or spinal cord, a condition that occurs due to bony overgrowths within the spinal canal.
</p>


                  
<p class="blogh2"><strong>Cervical Spine Surgery</strong> - This surgery is generally done on elective basis to treat two of these following conditions: </p>

<p class="blogh2"><strong>Spine instability</strong> - Cured using fusion surgery
</p>

<p class="blogh2"><strong>Spine cord or nerve impingement</strong> - Using decompression surgery
</p>

<p class="blogh2">
These two procedures are most of the time combined, owing to the fact that decompression tends to de-stabilize the spine and create a requirement for fusion to provide stability.
</p>

<p class="blogh2">Contact us to get an overall understanding of your spine and its ailments. Avail the best of facilities from our best spine surgeons to get cured and experience a healthy life again. 
</p>
