...
'</div>' +
        ...
        '<h5 style="padding-left:25px;text-transform:capitalize;"><a href="http://spacegm.com/cmcl/coronavirus/" style="color:#fff;"><i class="fa fa-exclamation-triangle" style="padding:0px 10px;"></i>COVID-19 : <span style="color:#fff;">What you need to know about the current outbreak of 2019 novel coronavirus</span>&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></a></h5>' +
        '</div>';
...
// '</div>' +
 ...
 '<li class="menu-item">' +
     ...
     '<li class="menu-item menu-item-has-children">' +
        ...
        '<marquee><a href="http://spacegm.com/cmcl/coronavirus/" style="font-size:20px;color:#fff;text-decoration:underline;"><i class="fa fa-exclamation-triangle" style="padding:0px 10px;"></i>COVID-19 : What you need to know about the current outbreak of 2019 novel coronavirus&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></a></marquee>'
        '</div>' +
        '</div>' ;
        // "<script type='text/javascript'>function googleTranslateElementInit(){new google.translate.TranslateElement({pageLanguage:'en',layout:google.translate.TranslateElement.FloatPosition.TOP_LEFT},'google_translate_element')}function triggerHtmlEvent(e,t){var n;document.createEvent?((n=document.createEvent('HTMLEvents')).initEvent(t,!0,!0),e.dispatchEvent(n)):((n=document.createEventObject()).eventType=t,e.fireEvent('on'+n.eventType,n))}jQuery('.lang-select').click(function(){console.log('clicked');var e=jQuery(this).attr('data-lang');jQuery('.goog-te-combo').val(e),location.reload()});</script>";
    $('#mobile').html(navbar);
